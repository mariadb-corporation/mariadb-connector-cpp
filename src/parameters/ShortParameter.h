...
#ifndef _SHORTPARAMETER_H_
#define _SHORTPARAMETER_H_
...
namespace mariadb
{
class ShortParameter  : public ParameterHolder {

  int16_t value;

public:
  ShortParameter(int16_t value);
  ...
  virtual unsigned long getValueBinLen() const { return 2; }
  ParameterHolder* clone() { return new ShortParameter(*this); }
  };
}
}
#endif