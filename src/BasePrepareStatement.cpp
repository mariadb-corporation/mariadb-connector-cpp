...
namespace mariadb
{
  ...
  BasePrepareStatement::BasePrepareStatement(
    ...
    : stmt(new MariaDbStatement(connection, resultSetScrollType, resultSetConcurrency, factory)),
      noBackslashEscapes(connection->getProtocol()->noBackslashEscapes()),
      useFractionalSeconds(connection->getProtocol()->getOptions()->useFractionalSeconds),
      autoGeneratedKeys(autoGeneratedKeys),
      exceptionFactory(factory.get()),
  ...
  */
  ...
  void BasePrepareStatement::addBatch(const SQLString& sql) {
    throw *exceptionFactory->create("addBatch(const SQString& sql) cannot be called on PreparedStatement");
  }

  int32_t BasePrepareStatement::executeUpdate(const SQLString& sql) {
    throw *exceptionFactory->create("executeUpdate(const SQString& sql) cannot be called on PreparedStatement");
  }

  int32_t BasePrepareStatement::executeUpdate(const SQLString& sql, int32_t autoGeneratedKeys)  {
    throw *exceptionFactory->create("executeUpdate(const SQString& sql, int32_t autoGeneratedKeys) cannot be called on PreparedStatement");
  }

  int32_t BasePrepareStatement::executeUpdate(const SQLString& sql, int32_t* columnIndexes) {
    throw *exceptionFactory->create("executeUpdate(const SQString& sql, int32_t* columnIndexes) cannot be called on PreparedStatement");
  }

  int32_t BasePrepareStatement::executeUpdate(const SQLString& sql, const SQLString* columnNames) {
    throw *exceptionFactory->create("executeUpdate(const SQString& sql, const SQLString* columnNames) cannot be called on PreparedStatement");
  }

  int64_t BasePrepareStatement::executeLargeUpdate(const SQLString& sql) {
    throw *exceptionFactory->create("executeLargeUpdate(const SQString& sql) cannot be called on PreparedStatement");
  }

  int64_t BasePrepareStatement::executeLargeUpdate(const SQLString& sql, int32_t autoGeneratedKeys) {
    throw *exceptionFactory->create("executeLargeUpdate(const SQString& sql, int32_t autoGeneratedKeys) cannot be called on PreparedStatement");
  }

  int64_t BasePrepareStatement::executeLargeUpdate(const SQLString& sql, int32_t* columnIndexes) {
    throw *exceptionFactory->create("executeLargeUpdate(const SQString& sql, int32_t* columnIndexes) cannot be called on PreparedStatement");
  }

  int64_t BasePrepareStatement::executeLargeUpdate(const SQLString& sql, const SQLString* columnNames) {
    throw *exceptionFactory->create("executeLargeUpdate(const SQString& sql), SQLString* columnNames cannot be called on PreparedStatement");
  }

  ResultSet* BasePrepareStatement::executeQuery(const SQLString& sql) {
    throw *exceptionFactory->create("executeQuery(const SQString& sql) cannot be called on PreparedStatement");
  }

  bool BasePrepareStatement::execute(const SQLString& sql) {
    throw *exceptionFactory->create("execute(const SQString& sql) cannot be called on PreparedStatement");
  }

  bool BasePrepareStatement::execute(const SQLString& sql, int32_t autoGeneratedKeys) {
    throw *exceptionFactory->create("execute(const SQString& sql, int32_t autoGeneratedKeys) cannot be called on PreparedStatement");
  }

  bool BasePrepareStatement::execute(const SQLString& sql, int32_t* columnIndexes) {
    throw *exceptionFactory->create("execute(const SQString& sql, int32_t* columnIndexes) cannot be called on PreparedStatement");
  }

  bool BasePrepareStatement::execute(const SQLString& sql, const SQLString* columnNames) {
    throw *exceptionFactory->create("execute(const SQString& sql, const SQLString* columnNames) cannot be called on PreparedStatement");
  }
}
}
